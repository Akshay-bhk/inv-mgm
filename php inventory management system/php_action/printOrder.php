...
<table align="center" cellpadding="0" cellspacing="0" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr>
                     <td colspan="3" style=" text-align: right;">Nr. Akshay Bharadhwaj K,</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Mysore,633256</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Tele: +91 8088892705,+91 8618961303.</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Email: akshay@gmail.com</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;color: blue;text-decoration: underline;">varun953863gmail.com</td>
                  </tr>
                  <tr>
